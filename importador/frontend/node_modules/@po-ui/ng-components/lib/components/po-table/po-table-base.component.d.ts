...
export declare abstract class PoTableBaseComponent implements OnChanges, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTableBaseComponent, never, never, { "hideTextOverflow": "p-hide-text-overflow"; "hideColumnsManager": "p-hide-columns-manager"; "hideBatchActions": "p-hide-batch-actions"; "hideActionFixedColumns": "p-hide-action-fixed-columns"; "hideTableSearch": "p-hide-table-search"; "autoCollapse": "p-auto-collapse"; "loadingShowMore": "p-loading-show-more"; "sort": "p-sort"; "showMoreDisabled": "p-show-more-disabled"; "striped": "p-striped"; "hideSelectAll": "p-hide-select-all"; "singleSelect": "p-single-select"; "selectableEntireLine": "p-selectable-entire-line"; "actionRight": "p-actions-right"; "maxColumns": "p-max-columns"; "filterType": "p-filter-type"; "items": "p-items"; "columns": "p-columns"; "container": "p-container"; "paramDeleteApi": "p-param-delete-api"; "height": "p-height"; "hideDetail": "p-hide-detail"; "literals": "p-literals"; "loading": "p-loading"; "actions": "p-actions"; "selectable": "p-selectable"; "infiniteScroll": "p-infinite-scroll"; "infiniteScrollDistance": "p-infinite-scroll-distance"; "serviceApi": "p-service-api"; "serviceDeleteApi": "p-service-delete"; "spacing": "p-spacing"; "filteredColumns": "p-filtered-columns"; "draggable": "p-draggable"; }, { "allSelected": "p-all-selected"; "allUnselected": "p-all-unselected"; "collapsed": "p-collapsed"; "expanded": "p-expanded"; "eventDelete": "p-delete-items"; "selected": "p-selected"; "showMore": "p-show-more"; "sortBy": "p-sort-by"; "unselected": "p-unselected"; "changeVisibleColumns": "p-change-visible-columns"; "columnRestoreManager": "p-restore-column-manager"; }, never, never, false, never>;
}
