...
export declare class PoTableColumnIconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoTableColumnIconComponent, "po-table-column-icon", never, { "column": "p-column"; "row": "p-row"; "icons": "p-icons"; }, {}, never, never, false, never>;
}
