...
export declare class PoTableDetailComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoTableDetailComponent, "po-table-detail", never, { "items": "p-items"; "isSelectable": "p-selectable"; "detail": "p-detail"; }, { "selectRow": "p-select-row"; }, never, never, false, never>;
}
