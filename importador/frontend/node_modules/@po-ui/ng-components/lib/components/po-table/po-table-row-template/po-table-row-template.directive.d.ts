...
export declare class PoTableRowTemplateDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTableRowTemplateDirective, "[p-table-row-template]", never, { "poTableRowTemplateShow": "p-table-row-template-show"; "tableRowTemplateArrowDirection": "p-table-row-template-arrow-direction"; }, {}, never, never, false, never>;
}
