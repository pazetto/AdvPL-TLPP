...
export declare class PoSlideItemComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoSlideItemComponent, "po-slide-item", never, { "action": "p-action"; "alt": "p-alt"; "data": "p-data"; "image": "p-image"; "imageHeight": "p-image-height"; "template": "p-template"; "link": "p-link"; }, {}, never, never, false, never>;
}
