...
export declare class PoNavbarActionComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoNavbarActionComponent, "po-navbar-action", never, { "action": "p-action"; "icon": "p-icon"; "label": "p-label"; "link": "p-link"; "tooltip": "p-tooltip-text"; }, {}, never, never, false, never>;
}
