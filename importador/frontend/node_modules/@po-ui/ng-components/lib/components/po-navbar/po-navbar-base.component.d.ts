...
export declare abstract class PoNavbarBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoNavbarBaseComponent, never, never, { "iconActions": "p-icon-actions"; "items": "p-items"; "literals": "p-literals"; "logo": "p-logo"; "logoAlt": "p-logo-alt"; "shadow": "p-shadow"; }, {}, never, never, false, never>;
}
