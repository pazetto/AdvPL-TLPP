...
declare type PoImageLoading = 'lazy' | 'eager' | 'auto';
/**
 * @description
 *
...
export declare class PoImageBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoImageBaseComponent, never, never, { "height": "p-height"; "alternate": "p-alt"; "source": "p-src"; "priority": "p-priority"; "loading": "p-loading"; }, {}, never, never, false, never>;
}
export {};
