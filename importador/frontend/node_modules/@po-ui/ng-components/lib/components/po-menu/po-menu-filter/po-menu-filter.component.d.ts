...
export declare class PoMenuFilterComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoMenuFilterComponent, "po-menu-filter", never, { "loading": "p-loading"; "enableCollapse": "p-enable-collapse"; }, { "filter": "p-filter"; }, never, never, false, never>;
}
