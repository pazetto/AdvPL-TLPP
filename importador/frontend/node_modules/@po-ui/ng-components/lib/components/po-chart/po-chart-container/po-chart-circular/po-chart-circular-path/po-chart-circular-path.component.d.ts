...
export declare class PoChartCircularPathComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoChartCircularPathComponent, "[po-chart-circular-path]", never, { "serie": "p-serie"; }, { "onClick": "p-on-click"; "onHover": "p-on-hover"; }, never, never, false, never>;
}
