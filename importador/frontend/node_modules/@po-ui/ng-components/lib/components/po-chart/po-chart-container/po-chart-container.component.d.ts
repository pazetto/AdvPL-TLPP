...
export declare class PoChartContainerComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoChartContainerComponent, "po-chart-container", never, { "categories": "p-categories"; "type": "p-type"; "containerSize": "p-container-size"; "options": "p-options"; "series": "p-series"; }, { "serieClick": "p-serie-click"; "serieHover": "p-serie-hover"; }, never, never, false, never>;
}
