...
export declare abstract class PoChartCircularComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoChartCircularComponent, never, never, { "containerSize": "p-container-size"; "options": "p-options"; "series": "p-series"; }, { "circularClick": "p-circular-click"; "circularHover": "p-circular-hover"; }, never, never, false, never>;
}
