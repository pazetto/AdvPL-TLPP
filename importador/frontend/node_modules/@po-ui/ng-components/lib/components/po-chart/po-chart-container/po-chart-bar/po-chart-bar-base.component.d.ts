...
export declare abstract class PoChartBarBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoChartBarBaseComponent, never, never, { "categories": "p-categories"; "range": "p-range"; "containerSize": "p-container-size"; "series": "p-series"; }, { "barClick": "p-bar-click"; "barHover": "p-bar-hover"; }, never, never, false, never>;
}
