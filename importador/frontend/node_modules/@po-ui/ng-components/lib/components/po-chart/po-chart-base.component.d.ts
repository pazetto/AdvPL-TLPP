...
export declare abstract class PoChartBaseComponent implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoChartBaseComponent, never, never, { "title": "p-title"; "height": "p-height"; "type": "p-type"; "series": "p-series"; "categories": "p-categories"; "options": "p-options"; }, { "seriesClick": "p-series-click"; "seriesHover": "p-series-hover"; }, never, never, false, never>;
}
