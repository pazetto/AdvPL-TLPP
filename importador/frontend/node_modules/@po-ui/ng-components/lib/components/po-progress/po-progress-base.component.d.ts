...
export declare class PoProgressBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoProgressBaseComponent, never, never, { "info": "p-info"; "infoIcon": "p-info-icon"; "status": "p-status"; "text": "p-text"; "indeterminate": "p-indeterminate"; "value": "p-value"; }, { "cancel": "p-cancel"; "retry": "p-retry"; }, never, never, false, never>;
}
