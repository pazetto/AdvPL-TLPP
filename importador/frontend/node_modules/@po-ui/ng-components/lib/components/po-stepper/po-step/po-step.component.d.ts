...
export declare class PoStepComponent implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoStepComponent, "po-step", never, { "canActiveNextStep": "p-can-active-next-step"; "label": "p-label"; "status": "p-status"; }, {}, never, ["*"], false, never>;
}
