...
export declare class PoToolbarActionsComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoToolbarActionsComponent, "po-toolbar-actions", never, { "actions": "p-actions"; "actionsIcon": "p-actions-icon"; }, {}, never, never, false, never>;
}
