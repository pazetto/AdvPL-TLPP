...
export declare abstract class PoTabBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTabBaseComponent, never, never, { "label": "p-label"; "active": "p-active"; "disabled": "p-disabled"; "hide": "p-hide"; }, { "click": "p-click"; }, never, never, false, never>;
}
