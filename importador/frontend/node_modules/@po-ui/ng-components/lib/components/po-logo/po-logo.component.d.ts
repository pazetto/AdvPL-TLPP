...
export declare class PoLogoComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoLogoComponent, "po-logo", never, { "className": "p-class"; "link": "p-link"; "logo": "p-logo"; "logoAlt": "p-logo-alt"; }, {}, never, never, false, never>;
}
