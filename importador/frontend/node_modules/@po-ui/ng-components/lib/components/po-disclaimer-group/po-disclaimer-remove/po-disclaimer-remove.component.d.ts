...
export declare class PoDisclaimerRemoveComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoDisclaimerRemoveComponent, "po-disclaimer-remove", never, { "label": "p-label"; }, { "removeAllAction": "p-remove-all-action"; }, never, never, false, never>;
}
