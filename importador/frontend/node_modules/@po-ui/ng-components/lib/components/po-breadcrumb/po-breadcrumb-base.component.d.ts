...
export declare class PoBreadcrumbBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoBreadcrumbBaseComponent, never, never, { "favoriteService": "p-favorite-service"; "paramsService": "p-params-service"; "items": "p-items"; }, {}, never, never, false, never>;
}
