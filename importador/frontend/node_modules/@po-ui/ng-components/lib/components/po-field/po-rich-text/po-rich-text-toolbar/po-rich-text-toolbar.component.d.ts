...
export declare class PoRichTextToolbarComponent implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoRichTextToolbarComponent, "po-rich-text-toolbar", never, { "disabledTextAlign": "p-disabled-text-align"; "readonly": "p-readonly"; }, { "command": "p-command"; "modal": "p-modal"; "linkEditing": "p-link-editing"; }, never, never, false, never>;
}
