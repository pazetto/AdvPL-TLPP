...
export declare class PoSelectComponent extends PoFieldValidateModel<any> implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoSelectComponent, "po-select", never, { "readonly": "p-readonly"; "placeholder": "p-placeholder"; "options": "p-options"; "fieldLabel": "p-field-label"; "fieldValue": "p-field-value"; }, { "ngModelChange": "ngModelChange"; }, never, never, false, never>;
}
