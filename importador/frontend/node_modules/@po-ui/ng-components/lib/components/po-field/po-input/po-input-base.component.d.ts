...
export declare abstract class PoInputBaseComponent implements ControlValueAccessor, Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoInputBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "icon": "p-icon"; "label": "p-label"; "help": "p-help"; "name": "name"; "errorPattern": "p-error-pattern"; "optional": "p-optional"; "upperCase": "p-upper-case"; "noAutocomplete": "p-no-autocomplete"; "placeholder": "p-placeholder"; "setDisabled": "p-disabled"; "setReadonly": "p-readonly"; "setRequired": "p-required"; "showRequired": "p-show-required"; "setClean": "p-clean"; "setPattern": "p-pattern"; "maxlength": "p-maxlength"; "minlength": "p-minlength"; "setMask": "p-mask"; "setMaskFormatModel": "p-mask-format-model"; }, { "blur": "p-blur"; "enter": "p-enter"; "change": "p-change"; "changeModel": "p-change-model"; }, never, never, false, never>;
}
