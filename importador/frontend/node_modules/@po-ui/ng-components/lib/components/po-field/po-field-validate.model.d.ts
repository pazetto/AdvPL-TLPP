...
export declare abstract class PoFieldValidateModel<T> extends PoFieldModel<T> implements Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoFieldValidateModel<any>, never, never, { "optional": "p-optional"; "required": "p-required"; "showRequired": "p-show-required"; }, {}, never, never, false, never>;
}
