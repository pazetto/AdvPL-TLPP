...
export declare abstract class PoUploadBaseComponent implements ControlValueAccessor, Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoUploadBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "dragDropHeight": "p-drag-drop-height"; "label": "p-label"; "help": "p-help"; "url": "p-url"; "name": "name"; "autoUpload": "p-auto-upload"; "optional": "p-optional"; "headers": "p-headers"; "requiredUrl": "p-required-url"; "directory": "p-directory"; "dragDrop": "p-drag-drop"; "hideRestrictionsInfo": "p-hide-restrictions-info"; "hideSelectButton": "p-hide-select-button"; "hideSendButton": "p-hide-send-button"; "literals": "p-literals"; "fileRestrictions": "p-restrictions"; "formField": "p-form-field"; "disabled": "p-disabled"; "isMultiple": "p-multiple"; "required": "p-required"; "showRequired": "p-show-required"; }, { "onUpload": "p-upload"; "onError": "p-error"; "onSuccess": "p-success"; "ngModelChange": "ngModelChange"; }, never, never, false, never>;
}
