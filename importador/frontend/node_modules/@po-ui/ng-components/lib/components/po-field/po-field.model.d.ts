...
export declare abstract class PoFieldModel<T> implements ControlValueAccessor {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoFieldModel<any>, never, never, { "label": "p-label"; "name": "name"; "help": "p-help"; "disabled": "p-disabled"; }, { "change": "p-change"; }, never, never, false, never>;
}
