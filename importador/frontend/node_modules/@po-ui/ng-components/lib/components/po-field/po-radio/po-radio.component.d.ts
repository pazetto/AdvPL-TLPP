...
export declare class PoRadioComponent extends PoFieldModel<boolean> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoRadioComponent, "po-radio", never, { "radioValue": "p-value"; "size": "p-size"; "required": "p-required"; "checked": "p-checked"; }, { "changeSelected": "p-change-selected"; }, never, never, false, never>;
}
