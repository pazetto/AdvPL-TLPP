...
export declare abstract class PoRadioGroupBaseComponent implements ControlValueAccessor, Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoRadioGroupBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "name": "name"; "optional": "p-optional"; "columns": "p-columns"; "disabled": "p-disabled"; "required": "p-required"; "showRequired": "p-show-required"; "options": "p-options"; "size": "p-size"; }, { "change": "p-change"; }, never, never, false, never>;
}
