...
export declare class PoDecimalComponent extends PoInputBaseComponent implements AfterViewInit, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoDecimalComponent, "po-decimal", never, { "decimalsLength": "p-decimals-length"; "thousandMaxlength": "p-thousand-maxlength"; "locale": "p-locale"; "min": "p-min"; "max": "p-max"; }, {}, never, never, false, never>;
}
