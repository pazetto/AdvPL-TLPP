...
export declare class PoLinkBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoLinkBaseComponent, never, never, { "label": "p-label"; "openNewTab": "p-open-new-tab"; "url": "p-url"; }, { "action": "p-action"; }, never, never, false, never>;
}
