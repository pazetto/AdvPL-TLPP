...
export declare class ProSessionSettingsComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProSessionSettingsComponent, "pro-session-settings", never, { "environment": "p-environment"; "background": "p-background"; "hideLogo": "p-hide-logo"; "highlightInfo": "p-highlight-info"; }, {}, never, never, false, never>;
}
