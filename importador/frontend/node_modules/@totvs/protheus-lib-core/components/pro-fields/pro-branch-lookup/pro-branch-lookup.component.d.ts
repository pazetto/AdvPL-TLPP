 ...
 */
export declare class ProBranchLookupComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProBranchLookupComponent, "pro-branch-lookup", never, { "parent": "parent"; "pLabel": "p-label"; "pHint": "p-hint"; "columns": "pro-columns"; }, { "branchSetted": "branchSetted"; }, never, never, false, never>;
}
