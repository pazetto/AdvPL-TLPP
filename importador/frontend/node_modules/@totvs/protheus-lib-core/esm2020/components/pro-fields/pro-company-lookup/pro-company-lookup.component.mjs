...
ProCompanyLookupComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ProCompanyLookupComponent, deps: [{ token: i1.ProCompanyLookupService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ProCompanyLookupComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.ProCompanyLookupService }]; }, propDecorators: { parent: [{
                type: Input
            }], companySetted: [{
                type: Output
            }], branchSetted: [{
