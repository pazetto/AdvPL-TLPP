...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ProSessionSettingsComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.UntypedFormBuilder }, { type: i2.Router }, { type: i3.ProMessageService }, { type: i2.ActivatedRoute }, { type: i4.ProSessionSettingsService }, { type: i5.ProCompanyService }, { type: i6.ProRoleService }, { type: i7.ProBranchService }, { type: i8.PoI18nService }, { type: i9.ProTranslateStringService }, { type: i10.ProBrandService }, { type: i11.ProSystemModuleService }]; }, propDecorators: { environment: [{
                type: Input,
                args: ['p-environment']
            }], background: [{
                type: Input,
